...
<br />
<div align="center">
  <a href="https://github.com/Dejahar/Full-Stack-Challenge/main">
  ...
  <h3 align="center">Astro GIFs</h3>

  <p align="center">
    Astro Gif is an academic sprint project to test what we could do in 48h
    <br />
    <a href="https://github.com/Dejahar/Full-Stack-Challenge/main"><strong>Explore the git »</strong></a>
    <br />
    <br />
...
* cd
  ```sh
  cd Full-Stack-Challenge/client
  ```
...
* cd
  ```sh
  cd Full-Stack-Challenge/server
  ```
...
Similar to the website https://giphy.com/ you can view GIfs and upload Gifs.
